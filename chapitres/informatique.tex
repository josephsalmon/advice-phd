...
pas importantes. Ce langage est enseigné au lycée et en classes préparatoires et tends à devenir une référence
dans les universités. Il est donc utile de le connaître si vous avez à enseigner.

Pour apprendre le python, vous pouvez utiliser le site 
\href{http://www.codecademy.com/tracks/python}{codecademy} 
qui donne des exercices en ligne pour apprendre par l'exemple.
Le livre de Kevin Sheppard peut aussi s'avérer utile: 
...
/* fonction qui prend en entrée un tableau de référence de 
...
interdépendant des chaînes de kikoolol */
